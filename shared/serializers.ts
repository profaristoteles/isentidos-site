...
export function normalizeCourseTypeToDatabase(type: string | CourseKindType | undefined, modality: ModalityType = ModalityType.PRESENTIAL): string {
  ...
  if (['preparatorio', 'preparatorio_isp', 'isp_preparatorios', 'enem', 'concurso', 'concursos'].includes(norm) || norm.includes('preparatorio') || norm.includes('enem') || norm.includes('concurso')) return 'preparatorio';
...
export function normalizeCourseTypeFromDatabase(type: string, modality: string = ''): CourseKindType {
  ...
  if (['preparatorio', 'preparatorio_isp', 'isp_preparatorios', 'enem', 'concurso', 'concursos'].includes(norm) || norm.includes('preparatorio') || norm.includes('enem') || norm.includes('concurso')) return CourseKindType.PREPARATORIO;
